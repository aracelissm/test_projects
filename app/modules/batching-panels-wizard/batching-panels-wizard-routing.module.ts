...
const routes: Routes = [
    {
        path: '',
        component: BatchingPanelsWizardComponent,
        children: [
            {
            ...
            },
            {
                ...
                data: { breadcrumb: 'Import Job Panel' }
            },
            {
                path: 'batch-job-panel/:jobKey/:stepOrder',
...
export class BatchingPanelsWizardRoutingModule {}
